import flet as ft
from Page.Zeli_Dialog import ZeliDialog2
import sqlite3
import os
import shutil
...
from Page.Prof import Gestion_Prof
from Page.classe import Gestion_Classe
from Page.Matiere import Gestion_Matiere
from Page.Students import Gestion_Eleve,Gestion_Eleve_Liste
from Page.Note import Saisie_Notes
from Page.Bulletin import Generation_Bulletin
from Page.sync_manager import sync_manager
#-----
...
def Submit(page , Ident , Pass): 
    ...
    def login_success(donner_info,Dial):
        ...
        if donner_info.get("role") != "creator":
            loading = Dialog.loading_dialog(
                title="Chargement...",
